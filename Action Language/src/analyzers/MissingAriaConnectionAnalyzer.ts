...
export class MissingAriaConnectionAnalyzer extends BaseAnalyzer {
  readonly name = 'missing-aria-connection';
  readonly description =
    'Detects ARIA attributes that reference non-existent elements';
            ...
            if (!referencedElement) {
              ...
              issues.push(
                this.createIssue(
                  ...
                  message,
                  element.location,
                  ['1.3.1', '4.1.2'], // WCAG 1.3.1: Info and Relationships, 4.1.2: Name, Role, Value
                  {
