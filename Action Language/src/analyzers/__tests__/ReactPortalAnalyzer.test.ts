...
import { ReactPortalAnalyzer } from '../ReactPortalAnalyzer';

describe('ReactPortalAnalyzer', () => {
  let analyzer: ReactPortalAnalyzer;

  beforeEach(() => {
    analyzer = new ReactPortalAnalyzer();
  });
  ...
  describe('accessibility concerns', () => {
    it('should flag all standard portal accessibility concerns', () => {
      ...
      expect(issues).toHaveLength(1);
      expect(issues[0].portal.accessibilityConcerns).toContain(
