 ...
 */
import { traverseAST, types as t } from './BabelParser';
/**
 * React Pattern Detector
 *
...
export class ReactPatternDetector {
    ...
    detectForwardRef(path, sourceFile) {
        ...
        const isForwardRef = (t.isMemberExpression(callee) &&
            t.isIdentifier(callee.object) &&
        ...
        if (t.isArrowFunctionExpression(componentArg) ||
    ...
    detectUseImperativeHandle(component, refParamName, sourceFile) {
        ...
        if (!t.isBlockStatement(component.body))
            return;
 ...
 * ```
 */
export function analyzeReactComponent(source, sourceFile) {
