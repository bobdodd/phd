...
class BaseAnalyzer {
    ...
    createIssue(type, severity, message, location, wcagCriteria, context, options) {
        ...
        const confidence = this.computeConfidence(context, options === null || options === void 0 ? void 0 : options.elementContext);
        return {
            type,
            severity,
            message,
            ...
            wcagCriteria,
            confidence,
            relatedLocations: options === null || options === void 0 ? void 0 : options.relatedLocations,
            elementContext: options === null || options === void 0 ? void 0 : options.elementContext,
            fix: options === null || options === void 0 ? void 0 : options.fix,
        };
    }
    /**
