...
class WidgetPatternAnalyzer extends BaseAnalyzer_1.BaseAnalyzer {
  ...
  <button role="tab" aria-selected="false" aria-controls="panel2">Tab 2</button>
            ...
            const hasArrowNav = nodes.some((n) => {
                var _a, _b, _c, _d;
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('ArrowLeft')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowRight')));
            });
            if (!hasArrowNav) {
                const fix = {
    ...
    validateDialogPattern(roleElements, nodes, context) {
        ...
        for (const dialog of dialogs) {
            ...
            const hasEscapeHandler = nodes.some((n) => {
                ...
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    ((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('Escape'));
            });
            if (!hasEscapeHandler) {
                const fix = {
  ...
  if (e.key === 'Escape') {
    closeDialog();
            ...
            const hasFocusTrap = nodes.some((n) => {
                ...
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    ((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('Tab'));
            });
            if (!hasFocusTrap) {
                const fix = {
        ...
        for (const combobox of comboboxes) {
            ...
            const hasArrowNav = nodes.some((n) => {
                ...
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    n.element.selector === elementSelector &&
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('ArrowDown')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowUp')));
            });
            if (!hasArrowNav) {
                const fix = {
      ...
      <div role="treeitem">Child Item</div>
            ...
            const hasArrowNav = nodes.some((n) => {
                ...
                return n.actionType === 'eventHandler' &&
                    ...
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('ArrowDown')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowUp')) ||
                        ((_f = (_e = n.handler) === null || _e === void 0 ? void 0 : _e.body) === null || _f === void 0 ? void 0 : _f.includes('ArrowLeft')) ||
                        ((_h = (_g = n.handler) === null || _g === void 0 ? void 0 : _g.body) === null || _h === void 0 ? void 0 : _h.includes('ArrowRight')));
            });
            if (!hasArrowNav) {
                const fix = {
...
for (let i = 1; i < buttons.length; i++) {
  ...
  <div role="row">
    ...
    <div role="gridcell">Cell 2,2</div>
            ...
            const has2DNavigation = nodes.some((n) => {
                var _a, _b, _c, _d, _e, _f;
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    ((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('Arrow')) &&
                    (((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowUp')) ||
                        ((_f = (_e = n.handler) === null || _e === void 0 ? void 0 : _e.body) === null || _f === void 0 ? void 0 : _f.includes('ArrowDown')));
            });
            if (!has2DNavigation) {
                const fix = {
  ...
  if (nextIndex !== currentIndex) {
    ...
    validateSliderPattern(roleElements, nodes, context) {
        ...
        for (const slider of sliders) {
            ...
            const hasArrowKeys = nodes.some((n) => {
                var _a, _b, _c, _d, _e, _f, _g, _h;
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    n.element.selector === elementSelector &&
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('ArrowLeft')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowRight')) ||
                        ((_f = (_e = n.handler) === null || _e === void 0 ? void 0 : _e.body) === null || _f === void 0 ? void 0 : _f.includes('ArrowUp')) ||
                        ((_h = (_g = n.handler) === null || _g === void 0 ? void 0 : _g.body) === null || _h === void 0 ? void 0 : _h.includes('ArrowDown')));
            });
            if (!hasArrowKeys) {
                const fix = {
  ...
  slider.setAttribute('aria-valuetext', value + '%');
    ...
    validateSpinbuttonPattern(roleElements, nodes, context) {
        ...
        for (const spinbutton of spinbuttons) {
            ...
            const hasUpDownKeys = nodes.some((n) => {
                var _a, _b, _c, _d;
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    n.element.selector === elementSelector &&
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('ArrowUp')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('ArrowDown')));
            });
            if (!hasUpDownKeys) {
                const fix = {
  ...
  spinbutton.setAttribute('aria-valuenow', String(value));
    ...
    validateSwitchPattern(roleElements, nodes, context) {
        ...
        for (const switchElem of switches) {
            ...
            const hasToggleHandler = nodes.some((n) => {
                var _a, _b, _c, _d;
                return (n.actionType === 'eventHandler' &&
                    (n.event === 'click' ||
                        (n.event === 'keydown' &&
                            (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('Enter')) ||
                                ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes(' ')))))) &&
                    n.element.selector === elementSelector;
            });
            if (!hasToggleHandler) {
                const fix = {
  ...
  if (e.key === ' ' || e.key === 'Enter') {
    ...
    validateBreadcrumbPattern(nodes, context) {
        ...
        for (const nav of navElements) {
            ...
            const hasBreadcrumbLabel = nodes.some((n) => {
                var _a;
                return n.actionType === 'ariaStateChange' &&
                    n.metadata.attribute === 'aria-label' &&
                    ((_a = n.metadata.value) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes('breadcrumb')) &&
...
<button aria-expanded="false">Toggle</button>`,
    ...
    validateCarouselPattern(nodes, context) {
        ...
        if (hasAutoRotation) {
            ...
            const hasPauseControl = nodes.some((n) => {
                var _a, _b, _c, _d, _e, _f;
                return n.actionType === 'eventHandler' &&
                    (((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('pause')) ||
                        ((_d = (_c = n.handler) === null || _c === void 0 ? void 0 : _c.body) === null || _d === void 0 ? void 0 : _d.includes('stop')) ||
                        ((_f = (_e = n.handler) === null || _e === void 0 ? void 0 : _e.body) === null || _f === void 0 ? void 0 : _f.includes('clearInterval')));
            });
            if (!hasPauseControl) {
...
<a href="/destination">Link text</a>`,
            ...
            const hasEnterHandler = nodes.some((n) => {
                var _a, _b;
                return n.actionType === 'eventHandler' &&
                    n.event === 'keydown' &&
                    ((_b = (_a = n.handler) === null || _a === void 0 ? void 0 : _a.body) === null || _b === void 0 ? void 0 : _b.includes('Enter')) &&
