...
const ReactPortalAnalyzer_1 = require("../analyzers/ReactPortalAnalyzer");
const ReactStopPropagationAnalyzer_1 = require("../analyzers/ReactStopPropagationAnalyzer");
...
describe('React Accessibility Integration Tests', () => {
    describe('Modal Component with Multiple Patterns', () => {
      ...
      `;
            ...
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Modal.tsx');
            ...
            // Run analyzers
            const portalAnalyzer = new ReactPortalAnalyzer_1.ReactPortalAnalyzer();
            ...
            const stopPropAnalyzer = new ReactStopPropagationAnalyzer_1.ReactStopPropagationAnalyzer();
    ...
    describe('Accessible Dialog with ForwardRef', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Dialog.tsx');
    ...
    describe('Theme Provider with Context', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'ThemeProvider.tsx');
    ...
    describe('Tooltip with Portal and stopPropagation', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Tooltip.tsx');
            // Should detect portal
            expect(analysis.portals).toHaveLength(1);
            ...
            const stopPropEvent = analysis.syntheticEvents.find((e) => e.methodsCalled.includes('stopPropagation'));
            expect(stopPropEvent).toBeDefined();
            const stopImmediateEvent = analysis.syntheticEvents.find((e) => e.methodsCalled.includes('stopImmediatePropagation'));
            ...
            const immediateIssue = stopPropIssues.find((i) => i.syntheticEvent.methodsCalled.includes('stopImmediatePropagation'));
            expect(immediateIssue?.severity).toBe('error');
            // stopPropagation should be warning severity
            const regularIssue = stopPropIssues.find((i) => i.syntheticEvent.methodsCalled.includes('stopPropagation') &&
    ...
    describe('Dropdown Menu with Focus Management', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Dropdown.tsx');
            ...
            // Should detect focus management
            expect(analysis.focusManagement.length).toBeGreaterThan(0);
            const focusActions = analysis.focusManagement.filter((f) => f.actionType === 'focusChange');
            expect(focusActions.length).toBeGreaterThan(0);
            // Should detect FocusContext usage
            const focusContext = analysis.contexts.find((c) => c.contextName === 'FocusContext');
            ...
            const preventDefaultEvents = analysis.syntheticEvents.filter((e) => e.methodsCalled.includes('preventDefault'));
    ...
    describe('Accessible Form with Multiple Hooks', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'AccessibleForm.tsx');
    ...
    describe('Announcement System with Context', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'NotificationButton.tsx');
            // Should detect multiple accessibility contexts
            const a11yContexts = analysis.contexts.filter((c) => c.metadata?.isAccessibilityRelated);
            expect(a11yContexts.length).toBe(3);
            // Verify specific contexts
            const announcementContext = analysis.contexts.find((c) => c.contextName === 'AnnouncementContext');
            expect(announcementContext).toBeDefined();
            expect(announcementContext?.metadata?.accessedProperties).toContain('announce');
            const notificationContext = analysis.contexts.find((c) => c.contextName === 'NotificationContext');
            expect(notificationContext).toBeDefined();
            const ariaContext = analysis.contexts.find((c) => c.contextName === 'AriaContext');
    ...
    describe('Complex Component with All Patterns', () => {
      ...
      `;
            const analysis = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'AccessibleModal.tsx');
            // Should detect useState
            ...
            expect(analysis.syntheticEvents.length).toBeGreaterThan(0);
            const stopPropEvents = analysis.syntheticEvents.filter((e) => e.methodsCalled.includes('stopPropagation'));
...
//# sourceMappingURL=ReactIntegration.test.js.map