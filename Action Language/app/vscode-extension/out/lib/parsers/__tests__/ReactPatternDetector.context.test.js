...
describe('ReactPatternDetector - Context', () => {
    describe('useContext detection', () => {
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'MyComponent.tsx');
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Component.tsx');
            const contexts = result.contexts.filter((c) => c.type === 'useContext');
            expect(contexts).toHaveLength(1);
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'test.tsx');
            const a11yContexts = result.contexts.filter((c) => c.metadata?.isAccessibilityRelated);
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'test.tsx');
            const nonA11yContexts = result.contexts.filter((c) => !c.metadata?.isAccessibilityRelated);
    ...
    describe('Context.Provider detection', () => {
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'App.tsx');
    ...
    describe('helper methods', () => {
      ...
      `;
            ...
            const consumerNames = consumers.map((c) => c.contextName);
    ...
    describe('accessibility implications', () => {
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'ThemedButton.tsx');
            const themeContexts = result.contexts.filter((c) => c.contextName === 'ThemeContext');
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'NotificationButton.tsx');
            const contexts = result.contexts.filter((c) => c.contextName === 'AnnouncementContext');
            expect(contexts).toHaveLength(1);
      ...
      `;
            ...
            const focusContexts = result.contexts.filter((c) => c.contextName === 'FocusContext');
      ...
      `;
            const result = (0, ReactPatternDetector_1.analyzeReactComponent)(code, 'Navigation.tsx');
            const keyboardContexts = result.contexts.filter((c) => c.contextName === 'KeyboardContext');
            ...
            expect(keyboardContexts[0].metadata?.accessedProperties).toContain('setKeyboardMode');
        });
    });
});
//# sourceMappingURL=ReactPatternDetector.context.test.js.map