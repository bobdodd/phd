...
const OrphanedEventHandlerAnalyzer_1 = require("../OrphanedEventHandlerAnalyzer");
const MissingAriaConnectionAnalyzer_1 = require("../MissingAriaConnectionAnalyzer");
const FocusOrderConflictAnalyzer_1 = require("../FocusOrderConflictAnalyzer");
const VisibilityFocusConflictAnalyzer_1 = require("../VisibilityFocusConflictAnalyzer");
...
describe('DOM-Aware Analyzers', () => {
    ...
    describe('OrphanedEventHandlerAnalyzer', () => {
        let analyzer;
        beforeEach(() => {
            analyzer = new OrphanedEventHandlerAnalyzer_1.OrphanedEventHandlerAnalyzer();
        });
        ...
        `,
            ...
            const context = { documentModel, scope: 'page' };
    ...
    describe('MissingAriaConnectionAnalyzer', () => {
        let analyzer;
        beforeEach(() => {
            analyzer = new MissingAriaConnectionAnalyzer_1.MissingAriaConnectionAnalyzer();
        });
    ...
    describe('FocusOrderConflictAnalyzer', () => {
        let analyzer;
        beforeEach(() => {
            analyzer = new FocusOrderConflictAnalyzer_1.FocusOrderConflictAnalyzer();
        });
    ...
    describe('VisibilityFocusConflictAnalyzer', () => {
        let analyzer;
        beforeEach(() => {
            analyzer = new VisibilityFocusConflictAnalyzer_1.VisibilityFocusConflictAnalyzer();
        });
...
//# sourceMappingURL=DOMAnalyzers.test.js.map