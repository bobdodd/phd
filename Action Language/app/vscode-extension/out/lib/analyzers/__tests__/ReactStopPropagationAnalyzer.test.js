...
const ReactStopPropagationAnalyzer_1 = require("../ReactStopPropagationAnalyzer");
describe('ReactStopPropagationAnalyzer', () => {
    let analyzer;
    beforeEach(() => {
        analyzer = new ReactStopPropagationAnalyzer_1.ReactStopPropagationAnalyzer();
    });
...
//# sourceMappingURL=ReactStopPropagationAnalyzer.test.js.map