    ...
    analyzeWithDocumentModel(context) {
        ...
        for (const elementContext of interactiveElements) {
            ...
            if (elementContext.hasClickHandler &&
                ...
                issues.push(this.createIssue('mouse-only-click', 'error', message, element.location, ['2.1.1'], // WCAG 2.1.1: Keyboard
                context, {
    ...
    analyzeFileScope(context) {
        ...
        for (const clickHandler of clickHandlers) {
            ...
            if (!hasKeyboardHandler) {
                ...
                issues.push(this.createIssue('mouse-only-click', 'warning', // Warning instead of error (might be false positive)
                message, clickHandler.location, ['2.1.1'], context, {
