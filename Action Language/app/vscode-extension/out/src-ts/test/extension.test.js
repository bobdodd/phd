...
suite('Analysis Tests', () => {
    ...
    `;
        ...
        const mouseOnlyIssue = diagnostics.find(d => d.message.includes('click') || d.message.includes('keyboard'));
    ...
    `;
        ...
        const mouseOnlyIssue = diagnostics.find(d => d.message.includes('mouse-only') || d.code === 'mouse-only-click');
